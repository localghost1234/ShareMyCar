...
class ReturnInterface(BaseInterface):
    ...
    def return_vehicle(self):
        ...
        """
        vehicle_id_entry = int(input("Vehicle ID: "))
        customer_name = self.system.get_customer_name(vehicle_id_entry)                           # Retrieve customer name associated with the vehicle
        ...
        try:
            vehicle_id = int(vehicle_id_entry)                                                          # Convert kilometers driven to integer
            actual_km = int(actual_km_entry)                                                          # Convert kilometers driven to integer
            late_days = int(late_days_entry)                                                          # Convert late days to integer
        except ValueError:
